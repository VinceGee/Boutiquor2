...
import zw.co.vokers.vinceg.boutiquor.utils.JsonUtil;
...
public class ClientTrackerActivity extends AppCompatActivity {
...
/*@Override
    public void onMapReady(GoogleMap googleMap) {
        ...
        HomePageActivity.pubnub.addListener(new SubscribeCallback() {
            @Override
        ...
        HomePageActivity.pubnub.subscribe()
                .channels(Arrays.asList(AppConfig.PUBNUB_CHANNEL_NAME)) // subscribe to channels
                .execute();
