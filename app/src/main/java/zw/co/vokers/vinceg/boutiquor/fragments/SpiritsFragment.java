...
import zw.co.vokers.vinceg.boutiquor.adapters.NonVegFoodAdapter;
...
public class SpiritsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spirits, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recyclerview_nonveg);
        adapter = new NonVegFoodAdapter(getContext(), beers);
    ...
    private void objRequestMethod(){
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, AppConfig.URL_SPIRITS, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                Log.d(TAG, jsonObject.toString());

                try{
                    JSONArray foodsJsonArr = jsonObject.getJSONArray("Spirits");
